...
import { getAllProducts } from "@/services/product.sevices";
...
export default async function ProductDetails({
  ...
  const relatedProductResponse  = await getAllProducts(product.category._id);
  const related :productI[]= relatedProductResponse.data
